...
function Home() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (data.meals == null) {
        alert(
          `Oops there is no ${searchQuery} but you can search for your fav dish`
        );
  ...
  return (
    <div
      style={{ display: "flex", flexDirection: "row", marginTop: "10vh" }}
      className=" max-w-xxl  border border-gray-200 rounded-lg shadow  "
    >
              ...
              <div className="wrap-card card-animate-card card-pop-card">
                <div className="overlay-card">
                  <div className="overlay-content-card card-animate-card slide-left-card delay-2-card">
                    ...
                    <p
                      className="p-card card-animate-card slide-left-card card-pop-card delay-5-card"
                  ...
                  <div
                    className="image-content-card card-animate-card slide-card delay-5-card"
                    style={{
                      backgroundImage: `url(https://media.gettyimages.com/id/1363638825/photo/vegan-plant-based-asian-food-recipes-with-rice-and-brown-rice-as.jpg?s=612x612&w=gi&k=20&c=QuqQ2wgvQazlitFvRhMuR2_nWZEf5CB3xa3FS4R0ffM=)`,
                    }}
                  ></div>
                ...
                <div className="text-card">
                  <div className="p-card">
                    <img
                      ...
                      src="https://media.gettyimages.com/id/1363638825/photo/vegan-plant-based-asian-food-recipes-with-rice-and-brown-rice-as.jpg?s=612x612&w=gi&k=20&c=QuqQ2wgvQazlitFvRhMuR2_nWZEf5CB3xa3FS4R0ffM="
                      alt=""
                    />
                    <em>
                      Healthy foods are those that provide you with the
                      nutrients you need to sustain your body's well-being and
                      retain energy. Water, carbohydrates, fat,
                      <div style={{ marginLeft: "10%" }}>
                        rotein, vitamins, and minerals are the key nutrients
                        that make up a healthy, balanced diet.
                      </div>{" "}
                    </em>
                  </div>
                </div>
