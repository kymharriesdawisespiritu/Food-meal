      ...
      <div className="wrap-card card-animate-card card-pop-card">
        <div className="overlay-card">
          <div className="overlay-content-card card-animate-card slide-left-card delay-2-card">
            <h1 className="h1-card card-animate-card slide-left-card card-pop-card delay-4-card">
              {meal.strTags}
            </h1>
            <p
        ...
        <div className="text-card">
          <div style={{ marginLeft: "5%" }} className="p-card">
            <img className="inset-card" src={meal.strMealThumb} alt="" />
            <em style={{ width: "100%" }}>{meal.strMeal}</em>
            {recipe.ingredients ? (
              <ul>
